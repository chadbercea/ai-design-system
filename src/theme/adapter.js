 ...
 */
export const mapTokensToMuiTheme = (tokens, mode = 'light') => {
  const isDark = mode === 'dark';
  return {
    palette: {
      primary: {
        main: isDark ? tokens.color.blue[700].value : tokens.color.blue[500].value,
        light: isDark ? tokens.color.blue[500].value : tokens.color.blue[300].value,
        dark: isDark ? tokens.color.blue[900].value : tokens.color.blue[700].value,
        contrastText: '#fff'
      },
      secondary: {
        main: isDark ? tokens.color.purple[700].value : tokens.color.purple[500].value,
        light: isDark ? tokens.color.purple[500].value : tokens.color.purple[300].value,
        dark: isDark ? tokens.color.purple[900].value : tokens.color.purple[700].value,
        contrastText: '#fff'
      },
      background: {
